...
const Login = () => {
  ...
  return (
    <div
      className="w-[80vw] h-screen m-auto  my-10 flex items-end flex-col bg-cover bg-center bg-no-repeat relative"
      style={{
        backgroundImage:
      ...
      <div className="w-[80vw] m-auto h-screen flex flex-col items-end pt-10 pr-15 relative" style={{fontFamily:'"Josefin Sans", sans-serif'}} >
        ...
        <div className="w-[30vw] pl-5 py-6 flex flex-col gap-6 bg-black/50 backdrop-blur-xl rounded-3xl border border-white/20 shadow-xl">
          ...
          <div className="flex w-[25vw] border border-white/20 h-12 rounded-3xl justify-center items-center bg-white/10 backdrop-blur-md">
            <NavLink
              to={"/log-in"}
              className={`w-[12vw] flex justify-center rounded-2xl items-center h-8 transition-all ${
          ...
          <form className="flex flex-col gap-4 text-white">
            ...
            <motion.div
              ...
              className="flex items-center justify-between border border-white/30 w-[25vw] h-11 rounded-3xl px-5 bg-white/10 backdrop-blur-md"
            >
              <input
                type="email"
          ...
          <div className="flex flex-col gap-3 text-white">
            <div className="flex items-center gap-1 w-[25vw] justify-center">
            ...
            <div className="flex flex-col gap-3">
              ...
              <motion.div whileHover={{ scale: 1.03 }}>
                <NavLink
                  to={"#"}
                  className="flex justify-center items-center w-[25vw] h-10 gap-2 rounded-3xl border border-white/30 bg-white/10 text-white shadow-xl"
                >
